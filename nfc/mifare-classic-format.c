/*-
 * Copyright (C) 2010, Romain Tartiere, Romuald Conty. <http://code.google.com/p/nfc-tools/wiki/libfreefare>
 * 
 ...
 * 
 * $Id: mifare-classic-format.c 568 2010-09-03 18:04:12Z rtartiere@il4p.fr $
 */
